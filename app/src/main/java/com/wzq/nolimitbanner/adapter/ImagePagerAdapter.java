 ...
 */
package com.wzq.nolimitbanner.adapter;
...
import com.wzq.nolimitbanner.ui.WebActivity;
...
public class ImagePagerAdapter extends BaseAdapter {
    ...
    public ImagePagerAdapter(Context context, List<Banner> banners) {
    ...
    public View getView(final int position, View view, ViewGroup container) {
        ...
        imageLoader.displayImage(
                banners.get(getPosition(position)).getPictureUrl(),
        ...
        holder.imageView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                String url = banners.get(ImagePagerAdapter.this
                        .getPosition(position)).getLinkUrl();
