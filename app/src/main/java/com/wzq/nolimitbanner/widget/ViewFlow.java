 ...
 * The default size of the buffer is mip2 elements on both sides of the currently
 * visible {@link View}, making up a total buffer size of mip2 * mip1 + 1 = 7. The
...
//			if(direction > 1) {
//				mCurrentAdapterIndex += mAdapter.getCount() - mip1;
//				mCurrentBufferIndex += mAdapter.getCount() - mip1;
//			}
